                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-8">
                            <div className="p-4 rounded-2xl bg-white dark:bg-white/[0.03] border border-stone-200 dark:border-white/[0.07] text-left">
                                ...
                                <p className="text-xs text-slate-500 dark:text-white/40 mb-1">Nous vous appelons</p>
                                <p className="text-sm font-bold text-slate-900 dark:text-white">Sous 24h</p>
                            </div>
                            <div className="p-4 rounded-2xl bg-white dark:bg-white/[0.03] border border-stone-200 dark:border-white/[0.07] text-left">
                                <ShoppingBag className="w-5 h-5 text-[#C8962E] mb-2" />
                                <p className="text-xs text-slate-500 dark:text-white/40 mb-1">Paiement</p>
                                <p className="text-sm font-bold text-slate-900 dark:text-white">À la livraison</p>
                            </div>
                        </div>
