    ...
    const NAV_GROUPS: NavGroup[] = [
       ...
       
        {
            ...
            items: [
                ...
                { label: 'Bons de sortie', href: '/dashboard/bons-sortie',     icon: LogOut        },
                { label: 'Transferts',   href: '/dashboard/transferts',        icon: ArrowLeftRight },
                { label: 'Dépôts',       href: '/dashboard/depots',            icon: Warehouse     },
            ],
        },
        {
            label: 'Logistique',
