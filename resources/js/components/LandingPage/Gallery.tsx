...
export function Gallery({ onDevis }: { onDevis: () => void }) {
  ...
  // Masonry layout avec des hauteurs différentes
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <FadeIn className="text-center mb-16">
          ...
          <p className="text-gray-500 dark:text-white/40 text-base max-w-2xl mx-auto">
            Découvrez nos projets les plus récents à travers la Guinée
          </p>
        </FadeIn>
              ...
              return (
                ...
                >
                  <span className={`relative z-10 flex items-center gap-1.5 ${
                    active ? 'text-white' : 'text-gray-600 dark:text-white/60'
                  }`}>
                  ...
                  <div className="relative overflow-hidden" style={{ aspectRatio: "4/3" }}>
                    ...
                    <div className="absolute top-3 left-3 z-10">
                      <span 
                        ...
                        style={{ 
                          background: `${catColor(item.cat)}22`, 
                          color: catColor(item.cat), 
                          border: `1px solid ${catColor(item.cat)}40`
                        }}
                      >
                        {item.cat}
                      </span>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-400">
                      ...
                      <p className="text-[#C8962E] text-xs flex items-center gap-1.5 mt-1">
