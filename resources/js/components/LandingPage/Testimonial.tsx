...
import { Quote, Star, Building2, Factory, Package, Home, User } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <FadeIn className="text-center mb-20">
          ...
          <p className="mt-4 text-gray-500 dark:text-white/40 text-lg max-w-2xl mx-auto">
            Découvrez les retours de nos partenaires et clients satisfaits
          </p>
        </FadeIn>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="relative mb-8">
              <Quote 
                size={80} 
                className="text-amber-300/40 dark:text-[#C8962E]/20 mx-auto" 
                strokeWidth={1.5}
              />
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              >
                <ActiveIcon size={40} style={{ color: active.color }} strokeWidth={1.5} />
              </div>
              ...
              <FadeIn key={t.name} delay={i * 0.1}>
                <button 
                  ...
                  style={isActive ? {
                    ...
                    boxShadow: `0 20px 40px -12px ${t.color}20`
                  } : {}}
                >
                  {/* Étoiles */}
                  ...
                  <div className="flex items-center gap-3 pt-3 border-t border-gray-100 dark:border-white/5">
                    <div 
                      ...
                      style={{ 
                        background: isActive ? `${t.color}15` : "rgba(200,150,46,0.08)"
                      }}
                    >
                      <CardIcon 
                        size={18} 
                        style={{ color: isActive ? t.color : "#C8962E" }} 
                      />
                    </div>
        ...
        >
          <div className="flex flex-wrap justify-center gap-8 items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-600 dark:text-white/40">
